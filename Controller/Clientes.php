<?php
    ...
    public function eliminados()
    {
        ...
        public function insertar()
        {
            ...
            $insert = $this->model->insertarClientes($rfc, $nombre, $telefono, $direccion);
            if ($insert > 0) {
            $alert = 'registrado';
    ...
    public function actualizar()
    {
        ...
        $telefono = $_POST['telefono'];
        $direccion = $_POST['direccion'];
        $actualizar = $this->model->actualizarClientes($rfc, $nombre, $telefono, $direccion, $id);
        if ($actualizar == 1) {
            $alert = 'modificado';
        }else {
            $alert = 'error';
    ...
    {
        $rfc = $_POST['rfc'];
        $data = $this->model->BuscarCliente($rfc);
