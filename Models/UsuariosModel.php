...
class UsuariosModel extends Mysql{
    public $id, $clave, $nombre, $usuario, $sexo, $rol;
    ...
    public function insertarUsuarios(string $nombre, string $usuario, string $sexo, string $clave, string $rol)
    {
        $return = "";
        $this->nombre = $nombre;
        ...
        $this->clave = $clave;
        $this->rol = $rol;
        $sql = "SELECT * FROM usuarios WHERE usuario = '{$this->usuario}' OR sexo = '{$this->sexo}'";
        $result = $this->select_all($sql);
        if (empty($result)) {
            $query = "INSERT INTO usuarios(nombre, usuario, sexo, clave, rol) VALUES (?,?,?,?,?)";
            $data = array($this->nombre, $this->usuario, $this->sexo, $this->clave, $this->rol);
    ...
    public function actualizarUsuarios(string $nombre, string $usuario, string $sexo, string $rol, int $id)
    {
        $return = "";
        $this->nombre = $nombre;
        $this->usuario = $usuario;
        ...
        $this->rol = $rol;
        $this->id = $id;
        $query = "UPDATE usuarios SET nombre=?, usuario=?, sexo=?, rol=? WHERE id=?";
        $data = array($this->nombre, $this->usuario, $this->sexo,$this->rol, $this->id);
