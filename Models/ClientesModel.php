...
class ClientesModel extends Mysql{
    public $id, $rfc, $nombre, $telefono, $direccion;
    ...
    public function BuscarCliente(string $rfc)
    {
        $this->ruc = $rfc;
    ...
    public function insertarClientes(String $rfc, string $nombre, string $telefono, string $direccion)
    {
        $return = "";
        $this->ruc = $rfc;
        $this->nombre = $nombre;
    ...
    public function actualizarClientes(String $rfc, string $nombre, string $telefono, string $direccion, int $id)
    {
        $return = "";
        $this->ruc = $rfc;
        $this->nombre = $nombre;
