                ...
                <div class="col-lg-12 mt-2">
                    <div class="row">
                        <div class="col-lg-6 mb-2">
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#nuevo_cliente">Nuevo</button>
                            ...
                            <tbody>
                                <?php foreach ($data as $us) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $us['fecha_registro']; ?></td>
                                        <td><?php echo $us['usuario']; ?></td>
                                        <td><?php echo $us['sexo']; ?></td>
        ...
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url(); ?>Usuarios/insertar" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="sexo" class="form-control" type="text" name="sexo" placeholder="sexo">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="confirmar">sexo</label>
                ...
                <div class="card-footer">
                    ...
                    <a href="<?php echo base_url(); ?>/Usuarios/Listar" class="btn btn-outline-danger">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
